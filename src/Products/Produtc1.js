...
import Product1_1 from '../img/product/urun_page/product1_1';
import Product1_2 from '../img/product/urun_page/product1_2';
import Product1_3 from '../img/product/urun_page/product1_3';
    ...
    return (
        <div className='Container'>
            ...
            <div className='Card'>                   
                ...
                <Button className='add-basket button1' onClick={() => handleAddToCart(CourseItem[0])}>
                     <i className="icon shopping basket"></i>
                    Sepete Ekle
                </Button>

                <Button className='Like button1' onClick={() => handleAddToLike(CourseItem[0])}>
                ...
                <div className="ui link cards" style={{ marginTop:10 }}>
                    ...
                    <div style={{ width: "20rem",  marginLeft:10, display: 'block', marginBottom: 20,
                        ...
                        <div className="content"  style={{ marginTop:10}}>
                            <Link className="header" to='/urun2'>Güneş Ahsap Servis Tabağı</Link>
                            ...
                            <div className='extra content'>
                                <span className='right floated'>
                                    <Button className='button button1' to='/urun2' onClick={() => handleAddToCart(CourseItem[1])}>Sepete Ekle</Button>
                                </span>
                                <span>
                                    <ReactStars
                                    count={5}
