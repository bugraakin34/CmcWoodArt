...
import Product3_1 from '../img/product/urun_page/product3_1';
import Product3_2 from '../img/product/urun_page/product3_2';
import Product3_3 from '../img/product/urun_page/product3_3';
...
export default function Produtc3 () {
    ...
    return (
        <div className='Container'>
            ...
            <div className='Card'>                   
                ...
                <Button className='add-basket button1' onClick={() => handleAddToCart(CourseItem[2])}>
                    <i className="icon shopping basket"></i>
                    Sepete Ekle
                </Button>

                <Button className='Like button1' onClick={() => handleAddToLike(CourseItem[2])}>
                ...
                <p className="card-exp">
                    Ürün Ölçüsü : 29x14 cm Dayanıklı kayın ağacı ve gıda ile temasa uygun olarak üretilmiştir. 
                ...
                <div className="ui link cards" style={{ marginTop:10 }}>
                    ...
                    <div style={{ width: "20rem",  marginLeft:10, display: 'block', marginBottom: 20,
                        ...
                        <div className="content"  style={{ marginTop:10}}>
                            ...
                            <div className='extra content'>
                                <span className='right floated'>
                                    <Button variant="primary" to='/urun2'  className='button button1' onClick={() => handleAddToCart(CourseItem[1])}>Sepete Ekle</Button>
                                </span>
                                <span>
                                    <ReactStars
                                    count={5}
