...
import Product4_1 from '../img/product/urun_page/product4_1';
import Product4_2 from '../img/product/urun_page/product4_2';
import Product4_3 from '../img/product/urun_page/product4_3';
    ...
    return (
        <div className='Container'>
            ...
            <div className='Card'>                   
                ...
                <Button className='add-basket button1' onClick={() => handleAddToCart(CourseItem[3])}>
                    <i className="icon shopping basket"></i>
                    Sepete Ekle
                </Button>

                
                <Button className='Like button1' onClick={() => handleAddToLike(CourseItem[3])}>
            ...
            <div>
                <div className="ui link cards" style={{ marginTop:10 }}>
                    ...
                    <div style={{ width: "20rem",  marginLeft:10, display: 'block', marginBottom: 20,
                        ...
                        <div className="content"  style={{ marginTop:10}}>
                            <Link className="header" to='/urun2'>Ay Ahşap Servis Tabağı</Link>
                            <div className='description'>
                            Ürün Ölçüsü : 30 cm Dayanıklı kayın ağacı ve gıda ile temasa uygun olarak üretilmiştir. Gıda sunumu için herhangi bir zararlı madde vernik vb. Kimyasallar içermemektedir. %100 doğal kayın ağacından üretilmiştir. 
                            </div>
                            <div className='extra content'>
